...
const OrdersTable = () => {
  ...
  const columnsDef = [
    ...
    },
    {
      ...
      flex: 2,
      cellRenderer: ({ data: { active_date } }) => (
        <Chip
          label={
            active_date ? dayjs(active_date).format("DD/MM/YYYY") : "inactive"
          }
          color={active_date ? "success" : "error"}
          variant="outlined"
          size="small"
        />
      ),
  ...
  return (
    <>
      <div className="mb-4 flex flex-col justify-between gap-4 md:flex-row">
        <h3 className="text-base text-primary md:text-lg">Data Orderan</h3>
        <TextField
